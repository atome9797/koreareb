...
public class CommonPopup : BaseView
{
    //[SerializeField]
    ...
    public void ShowPopup_TwoButton(string content, string leftBtnName, string rigthBtnName, UnityAction leftBtnEvent = null, UnityAction rightBtnEvent = null)
    {
        //pTitle.text = title;
    ...
    public void ShowPopup_TwoButton(string content, string rigthBtnName, UnityAction leftBtnEvent = null, UnityAction rightBtnEvent = null)
    {
        //pTitle.text = title;
        pContent.text = content;
